...
$(window).on("load", function() {
    ...
    var gainedChartOne = new ApexCharts(
        document.querySelector("#subscribe-gain-chart-one"),
        gainedChartoptions
    );

    gainedChartOne.render();

    var gainedChartte = new ApexCharts(
        document.querySelector("#subscribe-gain-chart-two"),
        gainedChartoptions
    );

    gainedChartte.render();
    ...
    var orderChartOne = new ApexCharts(
        document.querySelector("#orders-received-chart-one"),
        orderChartoptions
    );

    orderChartOne.render();

    var orderCharttee = new ApexCharts(
        document.querySelector("#orders-received-chart-two"),
        orderChartoptions
    );

    orderCharttee.render();
    ...
    var avgsessionChartOne = new ApexCharts(
        document.querySelector("#avg-session-chartone"),
        sessionChartoptions
    );

    avgsessionChartOne.render();
    ...
    var supportChartOne = new ApexCharts(
        document.querySelector("#support-tracker-chart-one"),
        supportChartoptions
    );

    supportChartOne.render();
